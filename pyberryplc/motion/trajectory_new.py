...
class Segment:
    ...
    profiles of a line segment in the trajectory. It also contains the step
...
class TrajectoryPlanner:
    ...
    def optimize_trajectory(self, allow_dev: float) -> Trajectory:
        """
        Recreates the trajectory while reducing the global path deviation (i.e.
        the average of the maximum segment path deviations) as close as possible
        to `allow_dev`.
        """
